...
class Ui_TableDialog(object):
    def setupUi(self, TableDialog):
        ...
        spacerItem = QtWidgets.QSpacerItem(591, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_2.addWidget(self.pushButtonClose, 3, 2, 1, 1)
