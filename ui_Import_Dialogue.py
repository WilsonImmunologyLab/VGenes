...
class Ui_DialogImport(object):
    def setupUi(self, DialogImport):
        ...
        self.gridLayout.addWidget(self.labelpct, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.MaxImport, 8, 2, 1, 1)
        self.buttonBox = QtWidgets.QDialogButtonBox(DialogImport)
        self.buttonBox.setMaximumSize(QtCore.QSize(180, 16777215))
