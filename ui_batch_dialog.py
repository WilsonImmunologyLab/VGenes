...
class Ui_BatchDialog(object):
    def setupUi(self, BatchDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 560, 530))
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 479, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout_2.addWidget(self.LineEditCutoff, 2, 1, 1, 3)
