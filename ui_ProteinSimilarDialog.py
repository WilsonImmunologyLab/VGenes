...
class Ui_ProteinSimilarDialog(object):
    def setupUi(self, ProteinSimilarDialog):
        ...
        ProteinSimilarDialog.resize(633, 695)
        ...
        self.gridLayout_4.addWidget(self.pushButtonCancel, 3, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButtonConfirm, 3, 2, 1, 1)
    ...
    def retranslateUi(self, ProteinSimilarDialog):
        ...
        self.label_7.setText(_translate("ProteinSimilarDialog", "Sequence"))
